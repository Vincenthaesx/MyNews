...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton imageButton = findViewById( R.id.image_button_search_return );
        ...
        searchButton.setOnClickListener(view -> {
            ...
            else if(Objects.requireNonNull( searchQuery.getText() ).toString().isEmpty() || searchQuery.getText().toString().trim().length() == 0){
